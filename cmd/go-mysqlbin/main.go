...
var myto_addr = flag.String("myto_addr", "", "MySQL addr")
var myto_user = flag.String("myto_user", "", "MySQL user")
var myto_pass = flag.String("myto_pass", "", "MySQL password")
...
func main() {
	...
	if len(*myto_addr) > 0 {
		cfg.MytoAddr = *myto_addr
	}

	if len(*myto_user) > 0 {
		cfg.MytoUser = *myto_user
	}

	if len(*myto_pass) > 0 {
		cfg.MytoPassword = *myto_pass
	}
	if *server_id > 0 {
